...
export default function Home() {
  ...
  return (
    <div style={{ background: '#FAF9F6', minHeight: '100vh', color: '#3D3929' }}>
      ...
      <header style={{
        ...
        <div style={{
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
            ...
            />
            <span className="hide-mobile" style={{ color: '#6B6860', fontSize: '13px', fontStyle: 'italic' }}>
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
            <span style={{
              ...
              <span className="hide-mobile">AGENT</span> LIVE
            </span>
        ...
        <div style={{
          ...
          <div style={{ display: 'flex', gap: '2px' }}>
            {[
              ...
              >
                {item.label}
                {item.live && <span style={{ color: '#5C8A5C', marginLeft: '4px', fontSize: '8px' }}>●</span>}
              </a>
            ))}
          </div>
          <div className="hide-mobile" style={{ fontSize: '11px', color: '#9A958C', marginLeft: '16px' }}>
      ...
      {/* Sticky CA Button - Hidden on mobile (they have the button in header) */}
