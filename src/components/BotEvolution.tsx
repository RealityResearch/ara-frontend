  ...
  return (
    <div id="evolution" style={{ marginBottom: '16px' }}>
      ...
      <div className="skeu-section-header">
        ...
        <span style={{ fontSize: '9px', color: '#FFCC00' }}>XP</span>
      </div>
      ...
      <div className="skeu-panel" style={{ borderRadius: '0 0 6px 6px', padding: 0 }}>
        {/* Level Banner */}
        <div style={{
          background: `linear-gradient(180deg, ${currentLevel.color}22 0%, ${currentLevel.color}44 50%, ${currentLevel.color}22 100%)`,
              ...
              <div className="skeu-panel" style={{ padding: '12px' }}>
                ...
                <div style={{ marginBottom: '8px' }}>
                  ...
                  <div style={{
                    ...
                    <div style={{
                      background: `linear-gradient(180deg, ${currentLevel.color} 0%, ${currentLevel.color}BB 50%, ${currentLevel.color}88 100%)`,
                      width: `${progress}%`,
                      height: '100%',
            ...
            <div className="skeu-panel" style={{
              ...
              {BOT_LEVELS.map((level) => {
                ...
                return (
                  <div
                    key={level.name}
                    className={isCurrent ? 'skeu-btn' : ''}
                    style={{
                      flex: 1,
                      textAlign: 'center',
                      padding: '4px 2px',
                      background: isCurrent
                        ? `linear-gradient(180deg, ${level.color}44 0%, ${level.color}22 100%)`
                        : isUnlocked
                          ? 'linear-gradient(180deg, #ffffff 0%, #f0f0f0 100%)'
                          : 'linear-gradient(180deg, #e0e0e0 0%, #d0d0d0 100%)',
                      border: isCurrent ? `2px solid ${level.color}` : '1px solid #a0a0a0',
                      borderRadius: '3px',
